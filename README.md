# ポテパンキャンプ最終課題(20221/1/14〜2022/3/26)
最終課題は課題1~5を通して、商品詳細ページとカテゴリー詳細ページの静的に作られている部分を動的に作り直すといった内容の課題でした。  
RSpecを使ってテストを初めて書いたり、docker、Rubocop、CircleCI、Heroku、AWS S3など初めて触れる技術が多く、環境構築やツールの使い方に慣れるのに時間が掛かりました。  
また、最終課題では2名の現職エンジニアのレビューでLGTMが貰えなければ次の内容には進めないといったルールがあり、それまでの課題以上に綺麗にコードを書くことを学びました。  
